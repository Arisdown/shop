...
<script>
	...
	function saveEmp() {
		//var staffid=$("#staffid input:hidden[name='staffid']").val();
		...
		window.location.href = "http://localhost:8080/crm${pageContex.request.contextPath}/emp/update.do?loginname="
				+loginname+"&postid="+postid+"&staffname="+name+"&gender="+gender+
				"&ondutydate="+intime+"&loginpwd="+loginpwd+"&staffid="+staffid;
...
<form> 
<input type="hidden" value="${emp.staffid }" id="staffid" name="staffid"/>
</form>
