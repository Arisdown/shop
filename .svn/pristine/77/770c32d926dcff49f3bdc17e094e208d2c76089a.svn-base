...
<table border="0" cellspacing="0" cellpadding="0"  class="wukuang"width="100%">
  <tr>
    ...
    <td width="57%"align="right">
    	<!-- 添加部门 -->
       <a href="${pageContext.request.contextPath }/crm_html/html/department/addOrEditDepartment.jsp"><img src="${pageContext.request.contextPath }/crm_html/images/button/tianjia.gif" /></a>
...
<table width="100%" border="1" >
  ...
  <c:forEach items="${depts}" var="dept" >
  	 ...
  	 <td width="7%" align="center"><a href="${pageContext.request.contextPath }/dept/updateUI.do?id=${dept.depid}"><img src="${pageContext.request.contextPath }/crm_html/images/button/modify.gif" class="img"/></a></td>
  </tr>
  
  </c:forEach>
  <tr class="tabtd2">
    <td align="center">Java教学部</td>
  	<td width="7%" align="center"><a href="addOrEditDepartment.jsp"><img src="${pageContext.request.contextPath }/crm_html/images/button/modify.gif" class="img"/></a></td>
  </tr>
  <tr class="tabtd1">
