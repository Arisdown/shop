...
<script type="text/javascript">
           function saveDept(){
        	   ...
        	   //alert("http://localhost:8080/crm${pageContex.request.contextPath}/dept/update.do?deptid="+deptid+"&deptname="+deptname);
        	   window.location.href="http://localhost:8080/crm${pageContex.request.contextPath}/dept/update.do?deptid="+deptid+"&deptname="+deptname;
...
<table width="88%" border="0" class="emp_table" style="width:80%;">
  <tr>
    <input type="hidden" id="depid" value="${dept.depid }"/>
    <td width="10%">部门名称：</td>
